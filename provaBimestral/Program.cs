...
/*
	<Carlos Henrique Almeida Camilo>
	<Quinta-feira 19h>
*/
...
namespace Prova1
{
	...
	class Controle
	{
		...
		public string GetEmpresasSalgadoManha()
		{
           ...
           if (empresasSalgadoManha.Length > 0)
           {
               empresasSalgadoManha = empresasSalgadoManha.Substring(0, empresasSalgadoManha.Length - 2);
           }
		...
		public string GetAlimentoMaisPreferido()
		{
			...
			foreach(Quiosque comida in Quiosques)
			{
                if(comida.ServeBebida){
                bebida++;
                }
                ...
                if(comida.ServeSalgado){
                salgado++;
                 }
			}
			
			if(bebida > doce || salgado >= bebida)
			{
				if (bebida < salgado)
				{
